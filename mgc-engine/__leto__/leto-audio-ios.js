define("__leto__/leto-audio-ios.js", function(require, module, exports, process) {
    ...
    class LetoAudio {
        ...
        set src(url) {
            ...
            // cocos will set url as an object, need extract url from it
        ...
        play(offset) {
            ...
            if (this._currentSource) {
                if(!window.mgc.experimental || !window.mgc.experimental.force_mute) {
            ...
            this._currentSource.onended = () => {
                // clean for laya
                if(window.Laya && window.Laya.SoundManager && window.Laya.SoundManager.removeChannel) {
                    window.Laya.SoundManager.removeChannel(this)
                }
        ...
        _startSource(audio, offset) {
            if(audio && (!window.mgc.experimental || !window.mgc.experimental.force_mute)) {
                try {
                    if (!this.loop) {
                        if (audio.start) {
