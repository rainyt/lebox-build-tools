	! function i(a, c, u) {
		...
		for (var l = "function" == typeof require && require, e = 0; e < u.length; e++) s(u[e]);
		return s
	}({
		1: [function(e, t, n) {}, {}],
		2: [function(e, t, n) {
				...
				x = {
					...
					_write: function() {
						g = !(m = null), u(this.cacheDir + "/" + this.cachedFileName, JSON.stringify({
							...
							g = !1;
							for (var e = 0, t = y.length; e < t; e++) y[e]();
							y.length = 0, y.push.apply(y, v), v.length = 0
						})
					},
					writeCacheFile: function(e) {
						m ? e && y.push(e) : (m = setTimeout(this._write.bind(this), this.writeFileInterval), !0 === g ? e && v.push(e) : e && y.push(e))
					},
					_cache: function() {
						var t = this;
						for (var n in this.cacheQueue) {
							var e = function(e) {
									if (h = !1, e) {
										if (w.test(e.message)) return t.outOfStorage = !0, void(t.autoClear && t.clearLRU())
					...
					unzipAndCacheBundle: function(t, e, n, r) {
		...
		3: [function(e, t, n) {
			...
			var o, i, f = e("../cache-manager"),
				...
				v = cc.assetManager.presets,
				y = __globalAdapter.isSubContext;
			l.maxConcurrency = 8, l.maxRequestsPerFrame = 64, v.scene.maxConcurrency = 10, v.scene.maxRequestsPerFrame = 64;
			var b = {},
				w = {};
			...
			var O = y ? function(e, t, n) {
					e = (e = L(e, t).url).slice(o.length + 1);
			...
			l.downloadDomAudio = E, l.downloadScript = _, g.parsePVRTex = D, g.parsePKMTex = P, l.register({
				...
				".rm": C,
				".rmvb": C,
				bundle: function(e, u, s) {
					var t, l, n, r = cc.path.basename(e),
					...
					b[r] ? (n = "subpackages/".concat(r, "/config.").concat(o ? o + "." : "", "json"), h(r, u.onFileProgress, function(e) {
						...
						var t, n, r, i, a, c;
						e ? s && s(e) : o.isZip ? (t = o.zipVersion, n = "".concat(l, "/res.").concat(t ? t + "." : "", "zip"), r = n, i = u, a = function(e, t) {
							var n, r;
			...
			y ? (F = cc.assetManager.init, cc.assetManager.init = function(e) {
				F.call(cc.assetManager, e), o = e.subContextRoot || ""
			...
			}), F = cc.assetManager.init, cc.assetManager.init = function(e) {
				F.call(cc.assetManager, e), e.subpackages && e.subpackages.forEach(function(e) {
			...
			Object.assign(i, {
				...
				_runMainLoop: function() {
					...
					cc.debug.setDisplayStats(n.showFPS), e = function() {
						if (!t._paused) {
							if (t._intervalId = window.requestAnimFrame(e), 30 === i && !__globalAdapter.setPreferredFramesPerSecond && (o = !o)) return;
							r.mainLoop()
						}
					}, t._intervalId = window.requestAnimFrame(e), t._paused = !1
				},
				...
				_initEvents: function() {
					...
					false && __globalAdapter.onAudioInterruptionEnd(n), false && __globalAdapter.onAudioInterruptionBegin(e), __globalAdapter.onShow && __globalAdapter.onShow(n), __globalAdapter.onHide && __globalAdapter.onHide(e), this.on(i.EVENT_HIDE, function() {
						i.pause()
		...
		19: [function(e, t, n) {
			...
			function l(e) {
				...
				if (e._inc != t) {
					...
					for (var r in Z(e, "length", n.length), n) e[r] = n[r];
					e._inc = t
				}
			}
					...
					case y:
						...
						if (J(e, 0, o) && (f = e.prefix || "", d = e.namespaceURI, p = f ? " xmlns:" + f : " xmlns", t.push(p, '="', d, '"'), o.push({
							...
							if (t.push(">"), n && /^script$/i.test(u))
								for (; c;) c.data ? t.push(c.data) : Q(c, t, n, r, o), c = c.nextSibling;
							else
								for (; c;) Q(c, t, n, r, o), c = c.nextSibling;
							t.push("</", u, ">")
						} else t.push("/>");
						return;
					case T:
					case O:
						for (c = e.firstChild; c;) Q(c, t, n, r, o), c = c.nextSibling;
						return;
					case b:
			...
			u.prototype = Error.prototype, r(a, u), p.prototype = {
				...
				toString: function(e, t) {
					for (var n = [], r = 0; r < this.length; r++) Q(this[r], n, e, t);
					return n.join("")
				}
				...
				_inc: 1,
				insertBefore: function(e, t) {
					if (e.nodeType != O) return null == this.documentElement && e.nodeType == y && (this.documentElement = e), F(this, e, t), e.ownerDocument = this, e;
			...
			}, o(P, A), P.prototype.getElementsByTagName = (L.prototype = {
				nodeType: y,
			...
			}).getElementsByTagName, P.prototype.getElementsByTagNameNS = L.prototype.getElementsByTagNameNS, o(L, A), k.prototype.nodeType = b, o(k, A), H.prototype = {
				data: "",
				...
				nodeType: _
			}, o(W, H), V.prototype.nodeType = N, o(V, A), G.prototype.nodeType = 12, o(G, A), q.prototype.nodeType = 6, o(q, A), z.prototype.nodeType = E, o(z, A), $.prototype.nodeName = "#document-fragment", $.prototype.nodeType = O, o($, A), X.prototype.nodeType = x, o(X, A), K.prototype.serializeToString = function(e, t, n) {
				return Y.call(e, t, n)
		...
		21: [function(e, t, n) {
			...
			function H(e, t, n) {
				...
				var f, d = 0 < (f = r.indexOf(":")) ? (l = e.prefix = r.slice(0, f), e.localName = r.slice(f + 1)) : (l = null, e.localName = r),
					p = e.uri = n[l || ""];
						...
						function(n, e, r, o, i) {
							...
							for (;;) {
								try {
									...
									if (v < 0) return n.substr(h).match(/^\s*$/) || (m = o.doc, g = m.createTextNode(n.substr(h)), m.appendChild(g), o.currentElement = g);
									switch (h < v && t(v), n.charAt(v + 1)) {
										case "/":
											var y = n.indexOf(">", v + 3),
												b = n.substring(v + 2, y),
												w = d.pop();
											y < 0 ? (b = n.substring(v + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + b + " is not complete:" + w.tagName), y = v + 1 + b.length) : b.match(/\s</) && (b = b.replace(/[\s<].*/, ""), i.error("end tag name: " + b + " maybe not complete"), y = v + 1 + b.length);
											var _ = w.localNSMap,
												E = w.tagName == b;
										...
										default:
											...
											if (!S.closed && function(e, t, n, r) {
													...
													return o < t
												}(n, y, S.tagName, p) && (S.closed = !0, r.nbsp || i.warning("unclosed xml attribute")), f && N) {
			...
			var d = 0,
				...
				o = function() {
					...
					function o(e) {
						...
						}(this, o), (t = r.call(this))._$sn = v++, t.HAVE_NOTHING = d, t.HAVE_METADATA = p, t.HAVE_CURRENT_DATA = h, t.HAVE_FUTURE_DATA = m, t.HAVE_ENOUGH_DATA = g, t.readyState = d;
		...
		43: [function(e, t, n) {
						...
						var n = wx.request({
							...
							success: function(e) {
								var t = e.data,
									n = e.statusCode,
									r = e.header;
								switch (c.status = n, h.set(c, r), g.call(c, "loadstart"), v.call(c, u.HEADERS_RECEIVED), v.call(c, u.LOADING), c.responseType) {
									case "json":
										c.responseText = t;
										try {
									...
									case "arraybuffer":
										...
										for (var o = new Uint8Array(t), i = o.byteLength, a = 0; a < i; a++) c.responseText += String.fromCharCode(o[a]);
										break;
									default:
										c.response = null
								}
			...
			(n.default = y).UNSEND = 0, y.OPENED = 1, y.HEADERS_RECEIVED = 2, y.LOADING = 3, y.DONE = 4, t.exports = n.default
		}, {
			"./EventTarget.js": 29
		}],
		44: [function(e, t, n) {
		...
		50: [function(e, t, n) {
			...
			var o = x(e("./Canvas")),
				...
				v = x(e("./HTMLVideoElement")),
				y = x(e("./WebGLRenderingContext")),
			...
			n.cancelAnimationFrame = D, n.requestAnimationFrame = C, n.clearInterval = A, n.clearTimeout = M, n.setInterval = O, n.setTimeout = N
		}, {
			"./Audio": 23,
			"./Canvas": 24,
			"./EventIniter/index.js": 28,
