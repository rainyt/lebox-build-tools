...
var Canvas = $hx_exports["Canvas"] = function() {
	...
	if(wx.ext_createCanvas != null) {
		this._wxCanvas = wx.ext_createCanvas();
	} else {
...
Canvas.prototype = $extend(HTMLCanvasElement.prototype,{
	cleanup: function() {
		haxe_Log.trace("Canvas.cleanup!",{ fileName : "src/Canvas.hx", lineNumber : 42, className : "Canvas", methodName : "cleanup"});
		this._wxCanvas = null;
	...
	,uniformFix: function(gl,funName) {
		...
		haxe_Log.trace("uniformFix:",{ fileName : "src/Canvas.hx", lineNumber : 186, className : "Canvas", methodName : "uniformFix", customParams : [funName,call]});
		if(call != null) {
...
Context2d.prototype = {
	cleanup: function() {
		...
		haxe_Log.trace("Context2d.cleanup CONTEXT2D_COUNT = " + Context2d.CONTEXT2D_COUNT,{ fileName : "src/Context2d.hx", lineNumber : 74, className : "Context2d", methodName : "cleanup"});
		this._context = null;
	}
	...
	,drawImage: function() {
        ...
        this._context.drawImage(arguments[0],arguments[1],arguments[2],arguments[3],arguments[4]);
			...
			haxe_Log.trace("drawImage渲染异常：",{ fileName : "src/Context2d.hx", lineNumber : 164, className : "Context2d", methodName : "drawImage", customParams : [e]});
		}
	}
	,beginPath: function() {
	}
...
var HTMLImageElement = $hx_exports["HTMLImageElement"] = function() {
	...
	this._contextImage.onerror = function(err) {
		haxe_Log.trace("加载发生了异常：",{ fileName : "src/HTMLImageElement.hx", lineNumber : 29, className : "HTMLImageElement", methodName : "new", customParams : [err]});
	...
	if(Object.prototype.hasOwnProperty.call(HTMLUtils.tempFileMaps.h,path)) {
		if(callLocalPath) {
			...
			wx.getFileSystemManager().readFile({ filePath : tmp, encoding : encoding, success : function(res) {
				...
				haxe_Log.trace("临时文件读取失败：",{ fileName : "src/HTMLUtils.hx", lineNumber : 180, className : "HTMLUtils", methodName : "cacheAssets", customParams : [res]});
				fail();
			}});
		}
		return true;
	...
	HTMLUtils.downloadTempFile(path,function(res) {
		if(callLocalPath) {
			...
			wx.getFileSystemManager().readFile({ filePath : tmp, encoding : encoding, success : function(res) {
				...
				haxe_Log.trace("临时文件读取失败-2：",{ fileName : "src/HTMLUtils.hx", lineNumber : 221, className : "HTMLUtils", methodName : "cacheAssets", customParams : [res]});
				fail();
			}});
		}
	},fail);
...
var WebSocket = $hx_exports["WebSocket"] = function(url,protocols) {
	...
	haxe_Log.trace("创建wxsocket",{ fileName : "src/WebSocket.hx", lineNumber : 42, className : "WebSocket", methodName : "new"});
...
WebSocket.prototype = {
	close: function(code,reason) {
		haxe_Log.trace("wechat关闭",{ fileName : "src/WebSocket.hx", lineNumber : 84, className : "WebSocket", methodName : "close", customParams : [code,reason]});
...
var Window = $hx_exports["Window"] = function() {
	...
	this.innerWidth = window.__innerWidth;
	this.innerHeight = window.__innerHeight;
...
Window.share = function(shareData,icon,callback,extinfo,isWebPath,failCallBack) {
	...
	haxe_Log.trace("query:",{ fileName : "src/Window.hx", lineNumber : 323, className : "Window", methodName : "share", customParams : [param]});
	window.addEventListener("focus",Window.onShareFocus);
};
Window.onShareFocus = function(_) {
	haxe_Log.trace("分享回调！",{ fileName : "src/Window.hx", lineNumber : 328, className : "Window", methodName : "onShareFocus"});
...
XMLHttpRequest.prototype = $extend(EventElement.prototype,{
	...
	,send: function(data) {
		...
		var isCanCache = HTMLUtils.cacheAssets(this.url,this.responseType == "arraybuffer" ? "binary" : "utf8",function(res) {
			...
			haxe_Log.trace("Cache发生错误：",{ fileName : "src/XMLHttpRequest.hx", lineNumber : 108, className : "XMLHttpRequest", methodName : "send"});
			_gthis.onFail();
		},isCallBackPath);
		if(!isCanCache) {
	...
	,sendRequest: function(data) {
		var header = { };
		var keys = haxe_ds_StringMap.keysIterator(this._requestHeader.h);
		while(keys.hasNext()) {
			var key = keys.next();
	...
	,onFail: function() {
		this.changeReadyState(XMLHttpRequest.DONE);
		haxe_Log.trace("加载失败:" + this.url,{ fileName : "src/XMLHttpRequest.hx", lineNumber : 200, className : "XMLHttpRequest", methodName : "onFail"});
